...
import com.brightcove.cast.DefaultOptionsProvider;
...
public class GoogleCastOptionsProvider extends DefaultOptionsProvider {
        ...
        NotificationOptions notificationOptions =
                new NotificationOptions.Builder()
                        ...
                        .setTargetActivityClassName(
                                DefaultExpandedControllerActivity.class.getName())
                        .build();
